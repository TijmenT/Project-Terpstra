...
CREATE TABLE `urenregistratie` (
  ...
  `algenpro` varchar(255) NOT NULL,
  `greenboost` varchar(255) NOT NULL,
  `mixprof` varchar(255) NOT NULL,
  `potgrond` varchar(255) NOT NULL,
  `bestrijding` varchar(255) NOT NULL,
  `machine` varchar(255) NOT NULL,
  `stort` varchar(255) NOT NULL,
